...
interface MissionPhotosProps {
  ...
  setPhotos: (photos: Record<string, Photo[]> | ((prev: Record<string, Photo[]>) => Record<string, Photo[]>)) => void;
}

export const MissionPhotos: React.FC<MissionPhotosProps> = ({ missionId, photos, setPhotos }) => {
